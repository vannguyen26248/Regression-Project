...
```{r}
#read file
auto <-read.table("C:/Users/vanng/OneDrive/Documents/project1/auto-mpg.data",header= TRUE, col.names = c("mpg","cylinders", "displacement", "horsepower","weight", "acceleration","model_year", "origin", "car_name"))
